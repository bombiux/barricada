<?php get_header(); 
	...
	$count = -1;
	$script = '';
	$countries = array('GUATEMALA','HONDURAS','EL SALVADOR','NICARAGUA','COSTA RICA', 'PANAM[A');
	...
	$script = $script . 'iMapsData.data[0].roundMarkers[$count].tooltipContent = `<p style="text-align: center;"><strong>GUATEMALA</strong></p><br /> Confirmados <i id="gt-conf"> 200 </i><br /> Muertes <i id="gt-mu"> 1 </i><br /> Recuperados <i id="gt-rec"> 3 </i><br /> Activos <i id="gt-act"> 197 </i>`;';
	...
	document.addEventListener('DOMContentLoaded', function(){ 
		document.querySelector('.imapsContainer').addEventListener("mouseover", () => {
			...
			iMapsData.data[0].roundMarkers[5].tooltipContent = `<p style="text-align: center;"><strong>GUATEMALA</strong></p><br /> Confirmados <i id="gt-conf"> 200 </i><br /> Muertes <i id="gt-mu"> 1 </i><br /> Recuperados <i id="gt-rec"> 3 </i><br /> Activos <i id="gt-act"> 197 </i>`;
			iMapsData.data[0].roundMarkers[6].tooltipContent = `<p style="text-align: center;"><strong>GUATEMALA</strong></p><br /> Confirmados <i id="gt-conf"> 200 </i><br /> Muertes <i id="gt-mu"> 1 </i><br /> Recuperados <i id="gt-rec"> 3 </i><br /> Activos <i id="gt-act"> 197 </i>`;
			}
		);
	}, false);
	</script>
