<?php get_header(); 
	...
	$script = '';
$toconcat = <<<HTML 
iMapsData.data[0].roundMarkers[$count].tooltipContent = `<p style="text-align: center;"><strong>$countries[$count]</strong></p><br /> Confirmados <i id="gt-conf"> $conf </i><br /> Muertes <i id="gt-mu"> $muer </i><br /> Recuperados <i id="gt-rec"> $rec </i><br /> $act <i id="gt-act"> 197 </i>
HTML;
