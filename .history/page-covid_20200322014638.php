<?php get_header(); 
	...
	$script .= ' = ';
	$script .= ' \'<p style="text-align: center;"><strong>' . $countries[$count] . '</strong></p><br /> Confirmados <i id="'. $country .'-conf">' . $conf . '</i><br /> Muertes <i id="'. $country .'-mu">' . $muer . '</i><br /> Recuperados <i id="gt-rec">' . $rec . '</i><br /> Activos <i id="gt-act">' . $act . '</i>\'; ';
