...
HTML;
	...
	$script .= ' = ';
	$script .= ' \'<p style="text-align: center;"><strong>' . $countries[$count] . '</strong></p><br /> Confirmados <bold id='. $country .'-conf">' . $conf . '</i><br /> Muertes <bold id='. $country .'-mu">' . $muer . '</i><br /> Recuperados <bold id='. $country .'-rec">' . $rec . '</i><br /> Activos <bold id='. $country .'-act">' . $act . '</i>\'; ';
