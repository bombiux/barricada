<?php get_header(); 
	...
	$count = -1;
	$script = '';
	$countries = array(,'HONDURAS''NICARAGUA','REPÚBLICA DOMINICANA','PANAMÁ','COSTA RICA','EL SALVADOR','GUATEMALA');
	...
	$script .= ' = ';
	$script .= ' \'<p style="text-align: center;"><strong>' . $countries[$count] . '</strong></p><br /> Confirmados <i id="gt-conf">' . $conf . '</i><br /> Muertes <i id="gt-mu">' . $muer . '</i><br /> Recuperados <i id="gt-rec">' . $rec . '</i><br /> Activos <i id="gt-act">' . $act . '</i>\'; ';
