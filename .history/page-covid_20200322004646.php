<?php get_header(); 
	...
	$script = $script . 'iMapsData.data[0].roundMarkers[$count].tooltipContent = `<p style="text-align: center;"><strong>$countries[$count]</strong></p><br /> Confirmados <i id="gt-conf"> 200 </i><br /> Muertes <i id="gt-mu"> 1 </i><br /> Recuperados <i id="gt-rec"> 3 </i><br /> Activos <i id="gt-act"> 197 </i>`;';
